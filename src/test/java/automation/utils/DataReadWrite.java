...
public class DataReadWrite {
    ...
    public static String readDataFromFile(String Property) {
        try {
            Properties prop = ResourceLoader.loadProperties("./src/test/resources/testdata");
    ...
    public static boolean appendDataToFile(String Property, String Data, String filename) {
        PrintWriter pw = null;
        boolean result = false;
        try {
            //System.out.println("Start of try block");
    ...
    public static String readDataFromFile(String productName, String Property,String filename) {
        try {
            Properties prop = ResourceLoader.loadProperties("./src/test/resources/testdata/"+File.separator+filename);
            return prop.getProperty(Property);
        } catch (Exception ex) {
            ex.printStackTrace();
            return null;
